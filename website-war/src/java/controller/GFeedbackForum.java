...
@WebServlet(name = "GFeedbackForum", urlPatterns = {"/GFeedbackForum"})
public class GFeedbackForum extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("addFeedback".equals(action)) {
            ...
            if (selectedItem == null) {
                ...
                request.getRequestDispatcher("grocerfeedbackforum.jsp").forward(request, response);
                return;
            }
