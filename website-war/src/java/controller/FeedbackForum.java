...
@WebServlet(name = "FeedbackForum", urlPatterns = {"/FeedbackForum"})
public class FeedbackForum extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("addFeedback".equals(action)) {
            ...
            if (selectedItem == null) {
                ...
                request.getRequestDispatcher("feedbackforum.jsp").forward(request, response);
                return;
            }
            ...
            response.sendRedirect("FeedbackForum");
            return;
        }
