...
public class ViewProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (productId == null || productId.trim().isEmpty()) {
            System.out.println("ERROR: productId is missing, redirecting to home");
        ...
        try {
            ...
            if (storeId != null) {
                p = productFacade.findByProductAndStore(productId, storeId);
                if (p != null) {
                    relatedProducts = productFacade.findByStoreId(storeId);
                }
            } else {
                p = productFacade.find(productId);
                if (p != null) {
                    relatedProducts = productFacade.findByCategory1(p.getCategory());
                }
            }
            ...
            if (p != null) {
                ...
                request.setAttribute("stockquantity", p.getStockquantity());
                request.setAttribute("imagepath", p.getImagepath());
                ...
                if (userId != null) {
                    ...
                    if (relatedProducts.isEmpty()) {
                        ...
                        for (Product relatedProduct : relatedProducts) {
                            productIds.add(relatedProduct.getProductid());
                        }
                    }
                    ...
                    for (int i = 0; i < idArray.length(); i++) {
                        ...
                        System.out.println("DEBUG: Getting product by ID: " + recProductId);

                        if (recProduct != null && !recProduct.getProductid().equals(productId)) {
