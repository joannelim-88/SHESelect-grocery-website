...
<html>
    <head>
        ...
        <style>
            ...
            .add-feedback-form button[type="submit"] {
                width: fit-content;
                padding: 10px 20px;
            ...
            .add-feedback-form button[type="submit"]:hover {
                background-color: #5a4dbf;
            }

            #showFormBtn, #cancelBtn {
                margin-top: 20px;
                margin-bottom: 10px;
                padding: 8px 16px;
                font-size: 14px;
            ...
            #showFormBtn:hover, #cancelBtn:hover {
        ...
        <script>
            ...
            function toggleFeedbackForm() {
                ...
                if (form.style.display === "none") {
                    ...
                    btn.textContent = "Add New Feedback";
                }
            }

            document.getElementById('feedbackForm').addEventListener('submit', function (e) {
                const replyTo = document.getElementById('replyToId').value;
                const feedbackText = document.querySelector('[name="feedbackDetail"]').value.trim();
                const errorMsg = document.getElementById('errorMsg');

                if (feedbackText.toLowerCase().includes('@') && replyTo === "") {
                    e.preventDefault();
    ...
    <body>
        ...
        <div class="content-wrapper">
            ...
            <div class="feedback-filter">
                <form action="FeedbackForum" method="GET">
            ...
            <div class="add-feedback-form" id="addFeedbackForm" style="display: none;">
                <form action="FeedbackForum" method="POST">
                    ...
                    <p id="errorMsg" style="color: red; display: none;">Please select a customer to reply to.</p>
