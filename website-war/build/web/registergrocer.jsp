...
<html>
    ...
    <body>
        ...
        <div class="content-wrapper">
            ...
            <h3>List of Registered Grocers</h3>
            <%-- Show list of registered grocers--%>
            <%
                List<Grocer> grocerList = (List<Grocer>) request.getAttribute("grocerList");
                if (grocerList != null && !grocerList.isEmpty()) {
            %>
            <ul>
                <% for (Grocer g : grocerList) {%>
                <li><%= g.getGrocerid()%></li> 
                    <% } %>
            </ul>
            <%
            ...
            %>
            <p>No grocers registered yet.</p>
            <%
                }
            %>

            <br>
            <p><a href="addgrocer.jsp" class="btn">Register New Grocer</a></p>
        </div>
    </body>
</html>
