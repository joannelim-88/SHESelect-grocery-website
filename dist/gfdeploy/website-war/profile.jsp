...
<html>
    <head>
        ...
        <script>
            ...
            function CustomerInfo(customerid, password, name, age, email, phoneno, address) {
            ...
            function toggleEdit() {
                ...
                const inputs = form.querySelectorAll("input:not(#customerid):not([type=button]):not([type=submit])");
    ...
    <body>
        ...
        <div class="content-wrapper">
            ...
            <form action="Profile?action=edit" method="POST" class="profile-form">
                <table>
                    <tr>
                        <td>Username: </td>
                        <td><input type="text" name="username" size="20" value="<%= customer.getCustomerid()%>" readonly></td>
                    </tr>
                    <tr>
                        <td>Password: </td>
                        ...
                        <tr>
                            <td>Name: </td>
                            <td><input type="text" name="name" size="20" value="<%= customer.getName()%>" <c:if test="${!isEditMode}">readonly</c:if>></td>
                        </tr>
                        <tr>
                            <td>Age: </td>
                            <td>
                                <button type="button" onclick="document.getElementById('ageInput').stepDown()" <c:if test="${!isEditMode}">disabled</c:if>>-</button>
                            <input type="number" name="age" id="ageInput" min="0" max="100" value="<%= customer.getAge()%>" <c:if test="${!isEditMode}">readonly</c:if>>
                            <button type="button" onclick="document.getElementById('ageInput').stepUp()" <c:if test="${!isEditMode}">disabled</c:if>>+</button>
                            </td>
                        </tr>
                        <tr>
                            <td>Email: </td>
                            <td><input type="text" name="email" size="20" value="<%= customer.getEmail()%>" <c:if test="${!isEditMode}">readonly</c:if>></td>
                        </tr>
                        <tr>
                            <td>Phone no: </td>
                            <td><input type="text" name="phoneno" size="20" value="<%= customer.getPhoneno()%>" <c:if test="${!isEditMode}">readonly</c:if>></td>
                        </tr>
                        <tr>
                            <td>Location address: </td>
                            <td><input type="text" name="address" size="20" value="<%= customer.getAddress()%>" <c:if test="${!isEditMode}">readonly</c:if>></td>
                        </tr>
                    </table>
